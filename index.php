...
<div class="panel">
    ...
    <div class="panel-heading clearfix header-title-right">
        <label class="control-label t20 header-title-lb">GẠCH THẺ</label>
    </div>
    <?php
            ...
            <div class="col-md-6 col-md-offset-3" style="margin-top: 15px;">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="number" name="CardSeri" id="CardSeri" placeholder="Nhập số seri của thẻ" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="number" name="CardCode" id="CardCode" placeholder="Nhập mã thẻ dưới lớp cào" />
                    </div>
                </div>
...
?>
                    <tr>
        <td class="text-center"><span class='btn btn-danger'><?=$dl['loaithe'];?></span></td>
...
<?php
$TMQ_dulieu = $db->query("SELECT * FROM `TMQ_gachthe` WHERE `uid` = '".$TMQ['uid']."'");
foreach($TMQ_dulieu as $dulieu){ ?>
                <tr>
                <td><?php if($dulieu['trangthai'] == "Chờ Duyệt"){ 
                echo "<span class='btn btn-warning'>Chờ Duyệt</span>"; 
                }elseif($dulieu['trangthai'] == "Thành công"){
                echo "<span class='btn btn-success'>Thành công</span>"; 
                }else{
                 echo "<span class='btn btn-danger'>Thẻ Sai</span>"; 
                }?></td>
                 <td><font color="FF0000"><?=$dulieu['mathe'];?></font></td>
                  <td><font color="#003300"><?=$dulieu['serial'];?></font></td>
                   <td><span class='btn btn-info'><?=$dulieu['loaithe'];?></span></td>
